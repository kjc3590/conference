	...
	<section class="infomation">
		<div class="container">
			...
			<div class="infoSet type2">
				...
				<div class="divLeft"><p>바이오 Session</p><p>13:00 ~ 14:40</p></div>
				<div class="divContent"><p>화상창 감염 유발 세균 3종 동시검출용 real time PCR kit의 개발</p><p>의료진과 특허전문가 협업을 통한 의료기기개발</p><p>화상환자를 위한 압박의류 기술개발 및 상용화</p><p>고성능 Sliver Dressing개발</p></div>
				<div class="divRight"><p><span>SFC</span><br>한상훈 박사</p><p><span>인비전특허법인</span><br>장기석 변리사</p><p><span>소프트로닉스</span><br>유재흥 대표</p><p><span>PCG중앙연구소</span><br>이정숙 박사</p></div>
				<div class="divContent width504"><p>1. 화상창 감염 유발 세균 3종 동시검출용 real time PCR kit의 개발</p><p>2. 의료진과 특허전문가 협업을 통한 의료기기개발</p><p>3. 화상환자를 위한 압박의류 기술개발 및 상용화</p><p>4. 고성능 Sliver Dressing개발</p></div>
			</div>

			<div class="infoSet type2">
				<div class="divLeft"><p>IT Session</p><p>13:00 ~ 14:40</p></div>
				<div class="divContent"><p>화상창 감염 유발 세균 3종 동시검출용 real time PCR kit의 개발</p><p>의료진과 특허전문가 협업을 통한 의료기기개발</p><p>화상환자를 위한 압박의류 기술개발 및 상용화</p><p>고성능 Sliver Dressing개발</p></div>
				<div class="divRight"><p><span>SFC</span><br>한상훈 박사</p><p><span>인비전특허법인</span><br>장기석 변리사</p><p><span>소프트로닉스</span><br>유재흥 대표</p><p><span>PCG중앙연구소</span><br>이정숙 박사</p></div>
				<div class="divContent width504"><p>1. 화상창 감염 유발 세균 3종 동시검출용 real time PCR kit의 개발</p><p>2. 의료진과 특허전문가 협업을 통한 의료기기개발</p><p>3. 화상환자를 위한 압박의류 기술개발 및 상용화</p><p>4. 고성능 Sliver Dressing개발</p></div>
			...
			<p class="join">문의 및 신청 :<br> 070-7603-1954, 010-9949-0296, bestianos@bestian.kr</p>
		...
		<div class="container">
			...
			<form id="frm" method="post">
				<div class="confirm">
					...
					<p>사전등록 확인을 위해 신청자 정보를<br> 입력해주시기 바랍니다.</p>
				</div>
			</form>
			<div class="buttonWrapper">
